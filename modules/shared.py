...
parser.add_argument("--no-half-vae", action='store_true', default=True, help="do not switch the VAE model to 16-bit floats")
...
parser.add_argument("--share", action='store_true', default=False, help="use share=True for gradio and make the UI accessible through their site")
parser.add_argument("--ngrok", type=str, help="ngrok authtoken, alternative to gradio --share", default=None)
parser.add_argument("--ngrok-region", type=str, help="The region in which ngrok should start.", default="us")
parser.add_argument("--enable-insecure-extension-access", action='store_true', default=True, help="enable extensions tab regardless of other options")
...
parser.add_argument("--disable-safe-unpickle", action='store_true', default=True, help="disable checking pytorch models for malicious code")
parser.add_argument("--api", action='store_true', default=True, help="use api=True to launch the API together with the webui (use --nowebui instead for only the API)")
